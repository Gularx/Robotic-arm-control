...
public:
    ...
    /// \return         0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Get_IO_State(SOCKHANDLE ArmSocket, byte num, byte *state, byte *mode = nullptr);
    ...
    /// \return                             0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Save_Trajectory(SOCKHANDLE ArmSocket, char * filename, int* num, bool block);
    ///
    ...
    ///  RM_APISHARED_EXPORT
    ///
    RM_SERVICESHARED_EXPORT int Service_Get_Realtime_Push(SOCKHANDLE ArmSocket, int* cycle, int* port, bool* enable);
    ...
    ///  RM_APISHARED_EXPORT
    ///
    RM_SERVICESHARED_EXPORT int Service_Set_Realtime_Push(SOCKHANDLE ArmSocket, int cycle, int port, bool enable);
    ...
    ///  RM_APISHARED_EXPORT
    ///
    RM_SERVICESHARED_EXPORT void Service_Realtime_Arm_Joint_State(int port, RobotStatusListener RobotStatuscallback);
