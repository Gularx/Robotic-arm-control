...
/// \return                             0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Get_Wifi_Net(SOCKHANDLE ArmSocket, char * mode, char * ip, char * mask, char * mac);
...
/// \return                             0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Save_Trajectory(SOCKHANDLE ArmSocket, char * filename, int* num, bool block);
///
...
/// \return                             0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Get_Realtime_Push(SOCKHANDLE ArmSocket, int* cycle, int* port, bool* enable);
...
/// \return                             0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Set_Realtime_Push(SOCKHANDLE ArmSocket, int cycle, int port, bool enable);
...
///
RM_BASESHARED_EXPORT void Realtime_Arm_Joint_State(int port, RobotStatusListener RobotStatuscallback);
